...
def main():
    ...
    ext_signature3 = ext_scheme3.sign_batch(batch_messages, signer_ids=[0, 1, 2])
    ...
    ext_scheme4 = HierarchicalBatchedThresholdHBSScheme(
        parties=4,
        threshold_k=3,
        tree_height=4,
        subtree_height=2,
    ...
    ext_batch_result = ext_scheme4.sign_batch_in_subtree(
        messages=subtree_messages,
        signer_ids=[0, 1, 2],
    )
    ...
    ext_signature5 = ext_scheme5.sign(ext_message5, signer_ids=[0, 1, 2])
